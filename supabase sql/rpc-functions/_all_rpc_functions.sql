...
-- public.attempt_send_test_email(p_user_id text, p_input_email text, p_input_keyword text)
...
-- public.check_send_count(p_user_id text, p_limit integer)
...
-- public.force_add_8h_created_at()
...
-- public.get_latest_daily_news_html(p_keyword text, p_max_age_hours integer)
...
-- public.get_news_cache(p_keyword text)
...
-- public.get_user_email(p_user_id text)
...
-- public.insert_news_archive(json_payload text)
...
-- public.insert_news_archive(p_keyword text, p_content text)
...
-- public.log_email_send(p_user_id text, p_email text, p_keyword text)
...
-- public.normalize_subscriptions_keyword()
...
-- public.query_subscription_universal(p_user_id text, p_target_email text)
...
-- public.save_news_cache(p_keyword text, p_content text)
...
-- public.unsubscribe_universal(p_user_id text, p_target_email text)
...
-- public.update_subscription_safe(p_user_id text, p_new_email text, p_new_keyword text)
...
-- public.update_subscription_universal(p_user_id text, p_target_email text, p_new_email text, p_new_keyword text)
